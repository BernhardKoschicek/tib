...
subprojects = {
    'mesmy': {
        ...
        'begin': datetime(2021, 1, 15).strftime('%d.%m.%Y'),
        'end': datetime(2025, 1, 14).strftime('%d.%m.%Y'),
    ...
    'inventory': {
        ...
        'cooperation': [
            ...
            ' Department Istanbul)'],
        'employees': [],
        'begin': datetime(2019, 8, 29).strftime('%d.%m.%Y'),
        'end': datetime(2021, 8, 28).strftime('%d.%m.%Y'),
