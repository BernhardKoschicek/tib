...
presentations = [{
    ...
    "location": "Budapest",
    "date": datetime(2018, 4, 17).strftime('%d/%m/%Y'),
    ...
    "location": "Lille",
    "date": datetime(2018, 5, 31).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "location": "Ohio, USA",
    "date": datetime(2018, 6, 15).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Vratislav Zervan",
    ...
    "location": "Budapest",
    "date": datetime(2018, 10, 10).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "location": "Beograd",
    "date": datetime(2018, 11, 28).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "location": "Rijeka",
    "date": datetime(2019, 5, 31).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "location": "Wien",
    "date": datetime(2019, 10, 18).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Vratislav Zervan",
    ...
    "conference": "Arbeitstreffen „Byzantino-Serbian Border Zones in Transition: Migration and Elite Change in pre-Ottoman Macedonia“, 17.-18. Oktober 2019",
    "location": "Wien",
    "date": datetime(2019, 10, 17).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "date": datetime(2019, 10, 30).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    ...
    "location": "Athen",
    "date": datetime(2021, 4, 23).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "location": "Paris",
    "date": datetime(2021, 5, 28).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
    ...
    "location": "Beograd",
    "date": datetime(2021, 6, 24).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Vratislav Zervan",
    ...
    "location": "London",
    "date": datetime(2021, 7, 21).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Vratislav Zervan",
    ...
    "location": "Budapest",
    "date": datetime(2022, 5, 24).strftime('%d/%m/%Y'),
    "category": ["borderzones"]
}, {
    "presenter": "Mihailo Popović",
