...
The devastating impact of wars on world cultural heritage has been widely discussed after 1945. Scientific projects at the Austrian Academy of Sciences (ÖAW) have a long tradition of contributing to the study of the world's cultural heritage. Among them is the long-term project "Tabula Imperii Byzantini" (TIB) of the Austrian Academy of Sciences, which is compiling a historical atlas of the Byzantine Empire with special attention to the Balkan Peninsula and Asia Minor. Since 1966 (until now), monuments and their (then) current state have been documented by means of slides during travels. This unique collection of Byzantine monuments (around 52,000 slides) is a rich cultural asset and a pivotal point of the present project "The Digital Tabula Imperii Byzantini (Dig-TIB) as a Contribution to World Cultural Heritage" as well as future research work.
</p>
    <p>
The initiatives in the field of Digital Humanities and Byzantine Studies in recent years have prompted the scientific team of the TIB at the ÖAW to intensify those efforts not only to scan and preserve slides of the in-house TIB archive, but also to enable a platform for the adequate presentation and sustainable use of the data.</p>
    <p>
The aim of the project is not to limit itself to digitisation / preservation in general, but also to specifically embed the respective monuments and their fates in the past decades into the world cultural heritage in three different case studies. These case studies - "Cilicia and Isauria" (TIB 5, Friedrich Hild), "Eastern Thrace (Eurōpē)" (TIB 12, Andreas Külzer) and "Macedonia, northern part" (TIB 16, Mihailo Popovic) - were chosen because of the complex politico-military situation in the Middle East with its impact on the monuments in situ (TIB 5) and because they include areas whose infrastructures are developing rapidly with lasting consequences for the landscapes of the past and for the respective monuments (TIB 12 and TIB 16).
</p>
"""
