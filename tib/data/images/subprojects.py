...
montenegro = [
    {
        'path': f'{gallery_path}montenegro-relief.jpg',
    ...
    {
        'path': f'{gallery_path}montenegro_bucht_relief.jpg',
        'description': _l(
    ...
    {
        'path': f'{gallery_path}montenegro_relief.jpg',
        'description': _l(
...
borderzones = [
    {
        'path': f'{gallery_path}border_all.png',
...
digtib = [
    {
        'path': f'{gallery_path}lesnovo_1920_30.jpg',
        ...
        'path': f'{gallery_path}lesnovo_2010.jpg',
        ...
        'path': f'{gallery_path}Ohrid_Ancient_Theatre_1988.jpg',
        ...
        'path': f'{gallery_path}Ohrid_Ancient_Theatre_2008.jpg',
        ...
        'path': f'{gallery_path}Pylai_Kilikias_Gülek Bogazi_Blick_thumb.jpg',
        ...
        'path': f'{gallery_path}Pylai_Kilikias_google.jpg',
        ...
        'path': f'{gallery_path}euboia_1967.png',
...
holdura = [
    {
        'path': f'{gallery_path}holdura_doclea_1.jpg',
'description': _l('Bird\'s eye view of the Doclea archaeological excavation, A: Basilica A, B: Basilica B and cruciform church, Republic of Montenegro'),
        ...
        'path': f'{gallery_path}holdura_doclea_2.jpg',
'description': _l('Bird\'s eye view of the Doclea archaeological excavation, the western part of the city in the foreground, Republic of Montenegro'),
        ...
        'path': f'{gallery_path}holdura_sveti_nikola.jpg',
'description': _l('The monastery of Sveti Nikola Vranjina (in the centre of the picture) on Lake Skadar, Republic of Montenegro'),
        ...
        'path': f'{gallery_path}holdura_ratac.jpg',
