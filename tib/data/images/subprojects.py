...
montenegro = [
    ...
    {
        'path': f'{galleryPath}montenegro_bucht_relief.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}montenegro_relief.jpg',
        'description': _l(
...
borderzones = [
    {
        'path': f'{galleryPath}border_all.png',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}borderzones_kale_skopje.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}borderzones_ohrid_stadttor.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}borderzones_ohrid_samuilova.jpg',
        'description': _l(
...
digtib = [
    {
        'path': f'{galleryPath}lesnovo_1920_30.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}lesnovo_2010.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}Ohrid_Ancient_Theatre_1988.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}Pylai_Kilikias_google.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}euboia_1967.png',
        'description': _l(
        ...
        'path': f'{galleryPath}euboia_1972.png',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}digtib_melnik.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}digtib_melnik_2010.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}digtib_rila.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}digtib_rila_2010.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}digtib_ohrid_bucht_1968.jpg',
        'description': _l(
    ...
    {
        'path': f'{galleryPath}digtib_ohrid_bucht_2017.jpg',
        'description': _l(
...
holdura = [
    {
        'path': f'{galleryPath}holdura_doclea_1.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}holdura_doclea_2.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}holdura_sveti_nikola.jpg',
        'description': _l(
        ...
        'path': f'{galleryPath}holdura_ratac.jpg',
        'description': _l(
