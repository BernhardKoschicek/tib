...
balkan_hist_geo = [{
    ...
    'description': _l(
        'The document for the Rila Monastery of the Bulgarian Tsar Ivan III. Šišman (1378)'),
    ...
    'description': _l(
        'The abandoned church Vlaška cărkva in Popovi livadi, SW Bulgaria'),
    ...
    'description': _l(
        'Peter Soustal with Kostantinos, a resident of the village of Daphni, Greece'),
    ...
    'description': _l(
        'Documentation of an early Christian basilica in Bar, Montenegro'),
